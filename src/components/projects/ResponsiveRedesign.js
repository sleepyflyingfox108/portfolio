    ...
    return(
        <div id="responsive-redesign">
            <div id="intro">
                ...
                <span>Usability &amp; Accessibility Research</span>
                </Link>
                <span> &#x2022; </span> 
                ...
                <span> &#x2022; </span> 
                <Link href="#site" underline="hover" color="inherit">
            ...
            <div className='section'>
                ...
                <div id="background">
                    ...
                    <br></br>
                    <br></br>
                    <b>Usability describes how well a website's design guides users to its functions. Accessibility describes how its design considers users of different abilities and backgrounds. They are extremely important subjects of study because</b> most websites are made for a variety of people beyond just the designer. It is the user’s thought process that ultimately determines whether the site will solve the problem the designer set out to solve. Websites that are functional, but poorly designed, may be just as inefficient as websites that are completely non-functional in terms of users being able to complete their intended goal.
                    <br></br>
                    <br></br>
                    <b>A website’s responsivity, or the varying of its display for different screen sizes, is also important</b> in a world where different types of devices are increasingly becoming commonplace. A designer must take into account many types of screen sizes and shapes, since a user may end up viewing the website on any of these.
                    <br></br>
                    <br></br>
                    ...
                    <div className='website-link'>
                        ...
                        <span><em>The original site.</em></span>
                    </div>
                    <p><b>This was a solo project.</b></p>
                </div>
                <div id="research">
                    <h2>Usability &amp; Accessibility Research</h2>
                    <p>
                ...
                <div id="design">
                    ...
                    <div className='photo-row'>
                        ...
                        <img src={process.env.PUBLIC_URL + "/images/lo-fi-desktop-thumbnail-1.png"}></img>
                        </Link>
                        <Link href="https://raw.githubusercontent.com/sleepyflyingfox108/responsive-redesign-submission/main/assets/Tablet.png" target="_blank">
                            <img src={process.env.PUBLIC_URL + "/images/lo-fi-tablet-thumbnail-1.png"}></img>
                        </Link>
                        <Link href="https://raw.githubusercontent.com/sleepyflyingfox108/responsive-redesign-submission/main/assets/Phone.png" target="_blank">
                            <img src={process.env.PUBLIC_URL + "/images/lo-fi-phone-thumbnail-1.png"}></img>
                        </Link>
                    </div>
                    ...
                    <div className='photo-row'>
                        ...
                        <img src={process.env.PUBLIC_URL + "/images/hi-fi-desktop-thumbnail-1.png"}></img>
                        </Link>
                        <Link href="https://raw.githubusercontent.com/sleepyflyingfox108/responsive-redesign-submission/main/assets/hi-fi-tablet.png" target="_blank">
                            <img src={process.env.PUBLIC_URL + "/images/hi-fi-tablet-thumbnail-1.png"} id="hi-fi-tablet-thumbnail"></img>
                        </Link>
                        <Link href="https://raw.githubusercontent.com/sleepyflyingfox108/responsive-redesign-submission/main/assets/hi-fi-phone.png" target="_blank">
                            <img src={process.env.PUBLIC_URL + "/images/hi-fi-phone-thumbnail-1.png"} id="hi-fi-phone-thumbnail"></img>
                        </Link>
                    </div>
                    <em>Click to open the annotated prototype in another tab.</em>
                ...
                <div id="conclusion">
                    ...
                    <br></br>
                    As someone who usually works on teams that operate on the backend of websites, I am usually 90% concerned with functionality and 10% concerned with design. But during the making of this website, I learned just how important design is and how it’s equally important to functionality. I also had to keep in mind different devices, so I really had to think through making an intuitive and clean design.
                    <br></br>
                    This was also an extremely helpful project in thinking about how websites differ according to the needs of its customers and users. Not all companies will have the same user bases, so there is no "universal" right design although there are general design concepts to keep in mind.
                    <br></br>
                    <br></br>
                    All in all, I feel I have a much stronger grasp of HTML, CSS, and interface design, which is a helpful skill to have even as a primarily backend developer because the backend often influences the way the frontend works and vice versa.
                    </p>
                </div>
            </div>
